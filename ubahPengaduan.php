...
<div class="content-wrapper">
    ...
    <div class="card card-info ml-3 mr-4 ">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="cekUbahPengaduan.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                <input type ="hidden" name="id_pengaduan" value="<?=$pengaduan["id_pengaduan"];?>">
                <input type ="hidden" name="gambarLama" value="<?=$pengaduan["gambar"];?>">
                  <div class="form-group row">
                    <label for="nama" class="col-sm-2 col-form-label">Tgl Pengaduan</label>
                    <div class="col-sm-10">
                      <input type="date" class="form-control" name="tanggal" placeholder="Tanggal Pengaduan" value="<?=$pengaduan['tgl_pengaduan']?>">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <textarea class="form-control" name="isi" rows="3" placeholder="Enter ..."><?=$pengaduan['isi_laporan'];?></textarea>
                      </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <select class="form-control" name="status" value="<?$pengaduan['status'];?>">
